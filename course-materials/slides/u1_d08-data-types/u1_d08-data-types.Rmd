...
.midi[
.your-turn[
- [RStudio Cloud] > `AE 06 - Hotels + Data types` > open `type-coercion.Rmd` and knit.
- What is the type of the given vectors? First, guess. Then, try it out in R. 
If your guess was correct, great! If not, figure out why they have that type.
]
]
...
We can think of factors like characters (level labels) and an integer (level numbers) glued together
...
.small[
.your-turn[
- RStudio Cloud > `AE 06 - Hotels + Data types` > `hotels-forcats.Rmd` > knit
