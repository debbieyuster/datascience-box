...
- These data are provided in an unstructured format: you can always copy and paste, 
...
.pull-left[
- The **rvest** package makes basic processing and manipulation of HTML data straightforward
...
.your-turn[
- RStudio Cloud > `AE 08 - IMDB + Webscraping`.
