...
.your-turn[
- RStudio Cloud > `AE 09 - UoE Art + Functions`.
...
- By default they return (a.k.a. output) the last value computed in the function
...
--
- Function names should be short but clearly evoke what the function does
...
We will construct a data frame in lab this week, which will contain these URLs in the column: `uoe_art$link`
...
- If you get `HTTP Error 429 (Too many requests)` you might want to slow down your hits by adding a random wait (sleep) time between hitting each link
