...
.question[
How, if at all, does the relationship between width and height of paintings vary by 
...
not really there on the scatter plot of data, just as people imagine animal shapes in
...
to be 5.65 inches shorter than paintings without landscape features.
...
.question[
`school_pntg` has 7 levels: A = Austrian, D/FL = Dutch/Flemish, F = French, G = German, I = Italian,
S = Spanish, X = Unknown]
