...
Once done, make a green check mark on Zoom: Click 'Participants', then look for the Yes icon (green check mark). If you have questions, click the No icon (red X) under 'Participants'.
]
]
...
.instructions[
Once done, make a Yes (green check mark) in Zoom. If you have questions, make a No (red X).
]
...
**Monday**
- Synchronous meeting on Zoom, 11:20am - ?
- If you haven't already, finish and submit HW on Gradescope by 11:59pm
- Start learning the week's content (videos, readings, interactive tutorials)

**Tuesday and Wednesday**
- Finish learning the week's content and complete Video Quiz (in Canvas) by Weds 11:59pm
- If you have time, start working on the Pre-HW and HW

continued ->
---
## Weekly student workflow (continued)
**Thursday**
- Synchronous lab session on Zoom, 11:20am-12:50pm
- Finish lab
- Work on Pre-HW and HW

**Friday, Saturday, Sunday**
- Complete lab with groupmates and submit to Gradescope by Sunday 11:59pm
- I recommend you finish and submit Pre-HW and HW. Deadline is Monday night.
---
