...
between country and beliefs about climate change? Explain your reasoning.  
...
Two variables or events are called **independent** if there is no evident relationship or association between the two.
...
- Simpson's paradox illustrates the effect that omission of an explanatory 
...
## An explanation for the UC Berkeley results

Women tended to apply to more selective graduate programs - programs that had lower admittance rates. So on the whole, percentage wise, more women were rejected than men. But within each department, women's admission rates were roughly equal to, or higher than, men's admission rates.
