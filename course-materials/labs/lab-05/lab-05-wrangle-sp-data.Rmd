...
Clone the group’s lab-05-wrangle-sp-data assignment repo (from GitHub) into RStudio (within our course workspace) and open the file lab-05-wrangle-sp-data.Rmd.
