...
In the next exercise, let's calculate which states have the most Denny's locations *per thousand square miles*. This requires *join*ing information from the frequency tables you created in Exercise 9 with information from the `states` data frame.
