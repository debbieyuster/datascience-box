...
Draft report due **Thursday, December 3** 

Peer feedback due **Thursday, December 10**

Final report, presentation video, slides, repo due **Thursday, December 17**
...
Your team's Draft report is due **Thursday, December 3**. As you work on the draft, the focus should be on the analysis and less on crafting the final report. **Your draft must include a reasonable attempt at each analysis component - exploratory data analysis, inference or modeling, and drawing initial conclusions.** It does not need to be a final report, but should be a good part of the way there.

## Peer feedback

Critically reviewing others' work is a crucial part of the scientific process, and DATA 101 is no exception. You will be assigned another team's Draft Report to review, and another team will review your draft. As part of the review process, your Draft report is due by **Thursday, December 3**. After receiving the report to be peer-reviewed, you will have until **Thursday, December 10** to provide a detailed critique about the written report and data analysis. This feedback is intended to help your classmates create a high quality final project, as well as give you experience 
...
In addition to the write-up, your team must also create presentation slides that summarize and showcase your project. You may use any software for making the slides, such as Powerpoint, Keynote, Google Slides, or R Markdown (using the Xaringan package). Introduce your research question and dataset, showcase visualizations, and provide some conclusions. These slides should serve as a brief visual accompaniment to your write-up and will be graded for content and quality. For submission, convert these slides to a .pdf document to be submitted to Gradescope. The slides are due on **Thursday, December 17**.

## Video presentation

Sometime before **Thursday, December 17**, you/your group will upload a video presentation of your project to Techsmith Knowmia. Note that all members must present, and that there is a strict **10-minute time limit**.

For the presentation, you can speak over your slide deck, similar to the course lesson videos. Your presentation should not just be an account of everything you 
tried ("then we did this, then we did this, etc."), instead it should convey what 
choices you made, and why, and what you found.

*Recording and submission details to come.*

## Project repository

In addition to your Gradescope submissions, I will be checking your GitHub repository. This repository should be contributed to equally by all team members and should include
...
The repository must be finalized by **Thursday, December 17**.
